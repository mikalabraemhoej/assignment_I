...
class HANCModelClass(EconModelClass,GEModelClass):    
    ...
    def settings(self):
        ...
        self.unknowns = ['K','L1','L0'] # endogenous unknowns
        self.targets = ['clearing_A','clearing_L1', 'clearing_L0'] # targets = 0
    ...
    def setup(self):
        ...
        par.Nfix = 3*2 # number of fixed discrete states (here discount factor)
        ...
        par.delta = 0.1 # depreciation [determined in ss]
        par.Gamma_ss = 1.0
        ...
        par.max_iter_broyden = 1000 # maximum number of iteration when solving eq. system
